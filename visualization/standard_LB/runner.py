...
if __name__ == "__main__":
    ...
    manufactured_u = sympy.cos(2 * sympy.pi * x)*sympy.sin(6*sympy.pi*y)
    manufactured_v = sympy.cos(2 * sympy.pi * y)*sympy.sin(8*sympy.pi*x)
    ...
    for i in range(timesteps):
        ...
        if i % 1 == 0:
            ...
            utils.output_image(macroscopics, i, "dirichlet", potential, dx)
...
for i in range(timesteps):
    ...
    if i % 1 == 0:
        macroscopics = stepper.get_macroscopics_host(f_1)
        utils.process_error(macroscopics, expected_macroscopics, i, dx, norms_over_time)
        utils.output_image(macroscopics, i, "periodic", potential, dx)
