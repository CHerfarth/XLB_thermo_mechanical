...
if __name__ == "__main__":
    ...
    compute_backend = ComputeBackend.JAX  # Must be JAX for distributed multi-GPU computations. Distributed computations on WARP are not supported yet!
    ...
    simulation = LidDrivenCavity2D_distributed(
        omega, prescribed_vel, grid_shape, velocity_set, compute_backend, precision_policy
    )
