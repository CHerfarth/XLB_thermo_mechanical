...
class SolidMacroscopics(Operator):
    def __init__(self, grid, force, omega, boundaries=None, velocity_set=None, precision_policy=None, compute_backend=None):
        ...
        macro_vec = wp.vec(9, dtype=self.precision_policy.compute_precision.wp_dtype)
        ...
        def calc_macroscopics(
            ...
            m_12 = m_local[5]
            m_21 = m_local[6]
            g_x = self.compute_dtype(force[0, i, j, 0])
            g_y = self.compute_dtype(force[1, i, j, 0])
